...
import MobilizationCreatePage from './create';
...
// const InsideMobilization = connect(
//   stateToProps,
//   actionsToProps
// )(
...
//       return (!mobilization || !blocksIsLoaded || !widgetsIsLoaded) && hasId ? (
//         <Loading />
//       ) : (
//         <React.Fragment>
...
//             exact
//             path={`${path}/launch`}
//             component={MobilizationsLaunch}
//           />
//           <Route
//             exact
//             path={`${path}/launch/end`}
//             component={MobilizationsLaunchEnd}
//           />
//           <Route
//             exact
...
export default () => {
  ...
  return (
    <React.Fragment>
      <Route exact path='/' component={MobilizationList} />
      <Route
        exact
        path='/archived'
        render={(props) => <MobilizationList {...props} status='archived' />}
      />
      <Route exact path='/new' component={MobilizationCreatePage} />
      <Route path='/mobilizations/:mobilization_id' component={MobilizationDetail} />
    </React.Fragment>
  );
}
