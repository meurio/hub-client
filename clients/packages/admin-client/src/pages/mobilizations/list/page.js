      ...
      <SettingsPageLayout>
        ...
        <SettingsPageContentLayout containerClassName="lg-col-12">
          <List>
            ...
            {mobilizations &&
              mobilizations.map((mobilization, index) => (
                <Item
                ...
                >
                  <div
                    className="gray20"
                    onClick={() => this.handleSelectItem(mobilization)}
                  >
                    <Avatar {...mobilization} />
                  ...
                  <More
                    onClick={() => this.props.toggleMenu(index)}
                    index={index}
                  >
                    <MoreMenu active={menuActiveIndex === index}>
                      ...
                      <MoreMenuAction
                        ...
                        onClick={() => {
                          this.props.changeStatus(mobilization).then(() => {
                            this.props.toggleMenu(undefined);
                          });
                        }}
                        icon="archive"
